...
{        
    ...
    public class FtpConnection
    {
        ...
        private FtpWebRequest CreateWebRequest(string method, string uri)
        {
            ...
            ftpWebRequest.UseBinary = _useBinaryMode;
            ftpWebRequest.KeepAlive = false;
            ftpWebRequest.Timeout = _timeOut;
        ...
        public void Upload(string fileName,string remoteFileName)
        {
            ...
            string remotePath = _host + "/" + _remoteDirectory + "/" + remoteFileName;
        ...
        {
            Download(fileName, Path.Combine(GetLocalDirectoryName(), Path.GetFileName(fileName)));            
        }
        ...
        public void Download(string fileName, string localFileName)
        {
            ...
            string remotePath = _host + "/" + _remoteDirectory + "/" + fileName;
        ...
        {
            string remotePath = _host + "/" + _remoteDirectory + "/" + directoryName;           
            try
            {
